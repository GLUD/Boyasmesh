...
angular.module('Authentication')
    ...
    .factory('AuthenticationService', ['Base64', '$http', '$cookieStore', '$rootScope', '$timeout',
        function(Base64, $http, $cookieStore, $rootScope, $timeout) {
            ...
            service.Login = function(username, password, callback) {
               ...
               /* $timeout(function() {
                ...
                /* Use this for real authentication
                 ----------------------------------------------*/
                $http.post('php/login.php', { username: username, pass: password })
            ...
            service.SetCredentials = function(username, password, type, data) {
    ...
    .factory('Register', ['$http',
        function($http) {
            ...
            service.save = function(data,callback) {
                var data = $.param(data);
                //console.log(data);
                $http.post('php/guardar_users.php', data)
